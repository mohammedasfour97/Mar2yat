...
public class MasterSlayer {
    ...
    private String URL = "http://mriatservice.mriat.com/Service.asmx";///MyService
    private String ImageURl = "http://mriat.com/dist/img/";
                    ...
                    if (Objecttable.hasProperty(request_paramName.get(name_num))) {
                        ...
                        if (IsImage(request_paramName.get(name_num))) { /** Is Image );*/
                            ...
                            if (Objecttable.getProperty(request_paramName.get(name_num)).toString().equals("anyType{}")) {
                                ...
                                map.put(request_paramName.get(name_num), ImageURl + Objecttable.getProperty(request_paramName.get(name_num)).toString());
                            }
                        } else {
                            if (Objecttable.getProperty(request_paramName.get(name_num)).toString().equals("anyType{}")) {
